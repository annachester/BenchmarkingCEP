...
def inputVals2(row):
    ...
    timestamp=(multi)*360000+(chunkIndex)
    vel=0.0
    if chunkIndex==1:
        vel=176.0
    qua=0.0
    if chunkIndex==10 or chunkIndex==18 or chunkIndex==5 or chunkIndex==12 or chunkIndex==15 or chunkIndex==16:
        qua=251.0
    ids="R"+"2000070"
...
empty2.to_csv('and200%.csv', index=False,header=False) 