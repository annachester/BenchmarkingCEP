...
#$startflink
#START=$(date +%s)
#$flink run -c Q7_ITERPattern_I2 $jar --input $data_path1 --output $output_pathP --vel 150 --wsize 20 --times 4 --iter 4 --tput 1000000
#END=$(date +%s)
#DIFF=$((END - START))
#echo "Q7_ITERPattern_I2 run "$loop " select 30% : "$DIFF"s" >>$resultFile
#$stopflink
...
#$startflink
#START=$(date +%s)
#$flink run -c Q7_ITERQuery_I2 $jar --input $data_path1 --output $output_pathQ --vel 150 --wsize 20 --times 4 --iter 4 --tput 1000000
#END=$(date +%s)
#DIFF=$((END - START))
#echo "Q7_ITERQuery_I2 run "$loop " select 30% : "$DIFF"s" >>$resultFile
#$stopflink
#echo "------------ Flink stopped ------------" >>$resultFile
#now=$(date +"%T")
...
#$startflink
#START=$(date +%s)
#$flink run -c Q7_ITERPattern_I2 $jar --input $data_path2 --output $output_pathP --vel 150 --wsize 20 --times 5 --iter 5 --tput 500000
#END=$(date +%s)
#DIFF=$((END - START))
#echo "Q7_ITERPattern_I2 run "$loop " select 200% : "$DIFF"s" >>$resultFile
#$stopflink
#echo "------------ Flink stopped ------------" >>$resultFile
#now=$(date +"%T")
...
#$startflink
#START=$(date +%s)
#$flink run -c Q7_ITERQuery_I2 $jar --input $data_path2 --output $output_pathQ --vel 150 --wsize 20 --times 5 --iter 5 --tput 500000
#END=$(date +%s)
#DIFF=$((END - START))
#echo "Q7_ITERQuery_I2 run "$loop " select 200% : "$DIFF"s" >>$resultFile
#$stopflink
#echo "------------ Flink stopped ------------" >>$resultFile
#now=$(date +"%T")
...
$startflink
START=$(date +%s)
$flink run -c Q7_ITERPattern_I2 $jar --input $data_path3 --output $output_pathP --vel 150 --wsize 20 --times 5 --iter 5 --tput 500000
END=$(date +%s)
DIFF=$((END - START))
echo "Q7_ITERPattern_I2 run "$loop " select 1% : "$DIFF"s" >>$resultFile
$stopflink
echo "------------ Flink stopped ------------" >>$resultFile
now=$(date +"%T")
