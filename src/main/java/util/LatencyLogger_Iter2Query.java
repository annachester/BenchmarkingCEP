...
public class LatencyLogger_Iter2Query implements FlatMapFunction<Tuple3<KeyedDataPointGeneral, Integer, Integer>, String> {

    private static final Logger LOG = LoggerFactory.getLogger(LatencyLogger_Iter2Query.class);
    ...
    public LatencyLogger_Iter2Query() {}    @Override
    public void flatMap(
